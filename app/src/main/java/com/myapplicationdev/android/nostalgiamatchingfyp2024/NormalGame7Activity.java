...
public class NormalGame7Activity extends AppCompatActivity {
    ...
    private Stack<NormalGame7Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_game7);
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnCorrect3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(3, true));
                correct3 = true;
            }
        });
        ...
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-1, false));
                wrong.start();
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-2, false));
                wrong.start();
            }
        });
        imgBtnWrong3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-3, false));
                wrong.start();
            }
        });
        imgBtnWrong4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-4, false));
                wrong.start();
            }
        });
        imgBtnWrong5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-5, false));
                wrong.start();
            }
        });
        imgBtnWrong6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame7Activity.Action(-6, false));
                wrong.start();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NormalGame7Activity.this, NormalActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NormalGame7Activity.this, NormalGame8Activity.class);
                startActivity(intent);
                buttonClick.start();
            }
        });
    ...
    private void undoLastAction() {
        NormalGame7Activity.Action lastAction = actionStack.pop();
        if (lastAction != null) {
