...
public class ExpertGame8Activity extends AppCompatActivity {
    ...
    private Stack<ExpertGame8Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expert_game8);
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame8Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame8Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnCorrect3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame8Activity.Action(3, true));
                correct3 = true;
            }
        });
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-1, false));
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-2, false));
            }
        });
        imgBtnWrong3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-3, false));
            }
        });
        imgBtnWrong4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-4, false));
            }
        });
        imgBtnWrong5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-5, false));
            }
        });
        imgBtnWrong6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame8Activity.Action(-6, false));
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExpertGame8Activity.this, ExpertActivity.class);
    ...
    private void undoLastAction() {
        ExpertGame8Activity.Action lastAction = actionStack.pop();
        if (lastAction != null) {
