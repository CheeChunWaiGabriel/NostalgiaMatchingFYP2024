...
public class EasyGame6Activity extends AppCompatActivity {
    ...
    private Stack<EasyGame6Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new EasyGame6Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new EasyGame6Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new EasyGame6Activity.Action(-1, false));
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new EasyGame6Activity.Action(-2, false));
            }
        });
    ...
    private void undoLastAction() {
        EasyGame6Activity.Action lastAction = actionStack.pop();
        if (lastAction != null) {
