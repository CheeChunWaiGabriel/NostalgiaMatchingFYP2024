...
public class EasyGame2Activity extends AppCompatActivity {
    ...
    private Stack<EasyGame2Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new EasyGame2Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new EasyGame2Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new EasyGame2Activity.Action(-1, false));
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new EasyGame2Activity.Action(-2, false));
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EasyGame2Activity.this, EasyActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EasyGame2Activity.this, EasyGame3Activity.class);
                startActivity(intent);
                buttonClick.start();
            }
        });
