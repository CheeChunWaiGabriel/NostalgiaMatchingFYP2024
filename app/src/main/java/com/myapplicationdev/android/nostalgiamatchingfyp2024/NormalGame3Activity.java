...
public class NormalGame3Activity extends AppCompatActivity {
    ...
    private Stack<NormalGame3Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnCorrect3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(3, true));
                correct3 = true;
            }
        });
        ...
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-1, false));
                wrong.start();
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-2, false));
                wrong.start();
            }
        });
        imgBtnWrong3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-3, false));
                wrong.start();
            }
        });
        imgBtnWrong4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-4, false));
                wrong.start();
            }
        });
        imgBtnWrong5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-5, false));
                wrong.start();
            }
        });
        imgBtnWrong6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new NormalGame3Activity.Action(-6, false));
                wrong.start();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NormalGame3Activity.this, NormalActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NormalGame3Activity.this, NormalGame4Activity.class);
                startActivity(intent);
                buttonClick.start();
            }
        });
    ...
    private void undoLastAction() {
        NormalGame3Activity.Action lastAction = actionStack.pop();
        if (lastAction != null) {
