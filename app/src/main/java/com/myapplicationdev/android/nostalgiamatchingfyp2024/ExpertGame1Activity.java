...
public class ExpertGame1Activity extends AppCompatActivity {
    ...
    private Stack<ExpertGame1Activity.Action> actionStack = new Stack<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnCorrect1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame1Activity.Action(1, true));
                correct1 = true;
            }
        });
        imgBtnCorrect2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame1Activity.Action(2, true));
                correct2 = true;
            }
        });
        imgBtnCorrect3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actionStack.push(new ExpertGame1Activity.Action(3, true));
                correct3 = true;
            }
        });
        imgBtnWrong1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-1, false));
            }
        });
        imgBtnWrong2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-2, false));
            }
        });
        imgBtnWrong3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-3, false));
            }
        });
        imgBtnWrong4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-4, false));
            }
        });
        imgBtnWrong5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-5, false));
            }
        });
        imgBtnWrong6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showWrong();
                actionStack.push(new ExpertGame1Activity.Action(-6, false));
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExpertGame1Activity.this, ExpertGame2Activity.class);
                startActivity(intent);
                buttonClick.start();
            }
        });
    ...
    private void undoLastAction() {
        ExpertGame1Activity.Action lastAction = actionStack.pop();
        if (lastAction != null) {
